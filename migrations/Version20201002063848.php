 ...
 */
final class Version20201002063848 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, categories_id INT NOT NULL, libelle_article VARCHAR(255) NOT NULL, prix_ht_article DOUBLE PRECISION NOT NULL, image_article VARCHAR(255) NOT NULL, INDEX IDX_BFDD3168A21214B7 (categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
