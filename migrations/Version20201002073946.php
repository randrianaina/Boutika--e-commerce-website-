 ...
 */
final class Version20201002073946 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, id_sous_categorie_id INT NOT NULL, libelle_article VARCHAR(255) NOT NULL, prix_ht_article DOUBLE PRECISION NOT NULL, image_article VARCHAR(255) NOT NULL, INDEX IDX_BFDD3168F252D75F (id_sous_categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sous_categories (id INT AUTO_INCREMENT NOT NULL, id_categorie_id INT NOT NULL, libelle_sous_categorie VARCHAR(255) NOT NULL, INDEX IDX_DC8B13829F34925F (id_categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
